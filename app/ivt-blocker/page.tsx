// app/ivt-blocker/page.tsx
"use client";

import { useState } from "react";
import { Copy, CheckCircle, AlertTriangle, Globe, RefreshCw, Loader2, Shield, Zap, Check } from "lucide-react";
...
export default function IVTBlockerPage() {
    ...
    const [verificationStatus, setVerificationStatus] = useState<null | "loading" | "success" | "error">(null);
...
<script>
  ...
  window.googletag.cmd.push(() => {
    ...
    const verifyScriptPlacement = async () => {
        ...
        try {
            // Make API call to verify script placement
            ...
            <div className="max-w-4xl mx-auto px-6 py-8">
                ...
                >
                    ...
                    <p className="text-gray-500 mt-2">
                        Block invalid traffic and protect your ad revenue
                    </p>
                </motion.div>
                            ...
                            {verificationStatus && (
                                ...
                                >
                                    <div className="flex items-start gap-3">
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${verificationStatus === "success"
                                        ...
                                        <div className="flex-1">
                                            <p className={`font-medium ${verificationStatus === "success"
                                                ? "text-green-800"
                                                : verificationStatus === "error"
                                                    ? "text-red-800"
                                                    : "text-blue-800"
                                            ...
                                            {lastVerifiedSite && (
                                                <p className="text-sm text-gray-600 mt-1">
                                                    Checked: <span className="font-mono">{lastVerifiedSite}</span>
                                                </p>
                                            )}
                                            {verificationStatus === "error" && (
                                                <div className="mt-2 text-sm text-gray-600">
                                                    Make sure you've pasted the script in the <code className="bg-gray-100 px-1 rounded text-xs">{'<head>'}</code> section of your site.
                                                    <button
                    ...
                    {generatedScript && (
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h2 className="text-xl font-semibold text-gray-900">Generated IVT Blocker Script</h2>
                            </div>
                                ...
                                <pre className="text-sm text-green-400 whitespace-pre-wrap font-mono">
                                    {generatedScript.split('\n').map((line, i) => (
                                        <div key={i} className="flex">
                                            <span className="text-gray-500 text-right w-8 mr-3 select-none">{i + 1}</span>
                            ...
                            <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                                ...
                                <ol className="list-decimal list-inside space-y-1 text-blue-700 text-sm">
                                    ...
                                    <li>Paste it in the <code className="bg-blue-100 px-1 rounded text-xs">{'<head>'}</code> section of your website</li>
                                    <li>Replace <code className="bg-blue-100 px-1 rounded text-xs">"div-gpt-ad-123"</code> with your actual ad unit ID</li>
                                    <li>Use the "Verify Script Placement" button to confirm installation</li>
                                </ol>
                            </div>
                        </motion.div>
                    )}
