  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        if (stored) {
          const violations: StoredViolation[] = JSON.parse(stored);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }} className="space-y-10">
          ...
          {/* HERO */}
          <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.4 }} className="text-center mb-8">
            ...
            <motion.h1 initial={{ scale: 0.95 }} animate={{ scale: 1 }} transition={{ duration: 0.3 }} className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">
          ...
          {/* CTA CARDS */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.4 }} className="grid grid-cols-1 lg:grid-cols-2 gap-8">

            <Link href="/sites">
              <motion.div whileHover={{ y: -8 }} className="bg-gradient-to-br from-white to-gray-50/50 rounded-3xl border border-gray-200/50 p-8 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group overflow-hidden relative">
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">Discover potential AdSense policy issues across your website network instantly.</p>
                    </div>
                  </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">Get detailed reports on detected policy breaches and AI-driven solutions.</p>
                    </div>
                  </div>
          ...
          {/* DASHBOARD */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.4 }} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* START GUIDE */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.4 }} className="bg-white/70 backdrop-blur-sm rounded-3xl border border-gray-200/50 p-8 shadow-sm mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div key={index} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className="text-center p-6 rounded-2xl bg-gray-50/50 border border-gray-100 hover:bg-gray-100/50 transition">
          ...
          {safeSuggestions.length > 0 && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.4 }} className="bg-indigo-50/70 backdrop-blur-sm rounded-3xl border border-indigo-200/50 p-6">
